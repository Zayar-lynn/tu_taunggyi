  ...
  -->
    ...
    <div class="sidebar-wrapper">
        <ul class="nav">
            ...
            <li class="nav-item @if($url=="intro") active @endif">
                <a class="nav-link" href="{{url('admin/intro')}}">
            ...
            <li class="nav-item @if($url=="currantstudent") active @endif">
                <a class="nav-link" href="{{url('admin/currantstudent')}}">
                    <i class="material-icons">list</i>
                    <p>Currant Students List</p>
                </a>
            </li>
            <li class="nav-item @if($url=="finishedstudent") active @endif">
                <a class="nav-link" href="{{url('admin/finishedstudent')}}">
                    <i class="material-icons">list</i>
                    <p>Finished Students List</p>
                </a>
            </li>
            <li class="nav-item @if($url=="ourpartnercompany") active @endif">
                <a class="nav-link" href="{{url('admin/ourpartnercompany')}}">
                    <i class="material-icons">list</i>
