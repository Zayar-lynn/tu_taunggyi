...
@section('css')
    ...
    {{-- editor --}}
    {{-- <link rel="stylesheet" href="{!! asset('YawYwatWar-master/yywEditor/stylesheets/TextEditor.css') !!}">
...
@section('js')
    ...
    {{-- ckeditor --}}
    {{-- <script src="{!! asset('YawYwatWar-master/yywEditor/build/app.bundle.js') !!}"></script>
    <script src="{!! asset('YawYwatWar-master/index.test.js') !!}"></script> --}}
        ...
        $(document).ready( function () {
            ...
            $('#insert_event').on('submit',function (e)
            {
                ...
                ({
                    ...
                    $('#modalBox').modal('hide');
                    toastr_success('Insert event data successful');
                    load();
                  }
                });
                return false;
