        ...
        $(document).ready( function () {
            ...
            $('#insert_blog').on('submit',function (e)
            {
                ...
                ({
                    ...
                    $('#modalBox').modal('hide');
                    toastr_success('Insert blog data successful');
                    load();
                  }
                });
                return false;
            ...
            if(confirm('Are you sure You want to delete!')==true){
                $.ajax({
                        type: "POST",
                        url: "../major/delete/blog/"+id,

                        cache: false,
                        success: function(data){
                            toastr_success('Delete blog data successful');
                            load();
                        }
                    });
                }else{
            ...
            edit_data=function(id){
                ...
                $.ajax({
                  ...
                  success: function(data){
                    ...
                    //$('#update_des').html(blog['description']);
                    ...
                    $('#update_des').summernote('code',blog['description']);
                ...
                $.ajax
    		        ({
    		            ...
    		            $('#edit_modalBox').modal('hide');
                            toastr_success('Update blog data successful');
          				  	load();
          				  }
    		        });
    		        return false;
