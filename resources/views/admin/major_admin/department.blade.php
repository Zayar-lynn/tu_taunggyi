                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <span style="font-size:20px;">Department</span><button type="button" name="button" class="btn btn-success rounded-0 pull-right" data-target="#modalBox" data-toggle="modal" data-keyboard="false" data-backdrop="static">Add</button>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 offset-md-3">
                                  <div class="form-group">
                                    ...
                                    <input type="file" id="photo" name="photo" required class="form-control error_input_photo" onchange="displaySelectedPhoto('photo','image_id')">
                                        <span id="error_photo">
                            ...
                            <div class="row">
                                <div class="col-md-6 offset-md-3">
                                  <div class="form-group">
                                    ...
                                    <input type="file" id="photo_edit" name="photo" class="form-control error_input_photo" onchange="displaySelectedPhoto('photo_edit','image_edit_id')">
                                        <span id="error_photo">
                  ...
                  success: function(data){
                    if(data.length == 0){
                      ...
                      $.each(data,function(index,depart){
                          ...
                          let table=$('#depart_paginate').DataTable();
                          let td_generate='<a href="#down" data-id="'+id+'" class="btn btn-sm btn-outline-primary rounded-0 detail_depart">Detail</a>'+
                          '<a href="#" onclick="edit_depart('+id+')" data-target="#edit_modal" data-toggle="modal" data-keyboard="false" data-backdrop="static" class="btn btn-sm btn-outline-info rounded-0 edit_depart">Edit</a>'+
                          '<button class="btn btn-sm rounded-0 btn-danger" onclick="delete_depart('+id+')" data-id="'+id+'">Delete</button>';
                          table.row.add([no,image,name,email,head_of_depart,location,description,td_generate]).draw();
                      });
                  }
                  }
                });
