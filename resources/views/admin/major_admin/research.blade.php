                              ...
                              <div class="row">
                                  <div class="col-md-12">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="name_of_peer" id="name_of_peer" class="form-control">
                                      </div>
                                  </div>
                                  <div class="col-md-12">
                                      <div class="form-group">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-12">
                                    <label class="btn btn-primary upload_btn">
                                        Upload PDF<input type="file" id="upload_pdf" name="pdf" class="uploadFile img" value="Upload File" style="width: 0px;height: 0px;overflow: hidden;" required>
                                    </label>
                                  </div>
                              </div>
                            ...
                            <div class="modal-body">
                                ...
                                <form id="update_data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                          <label class="btn btn-primary upload_btn">
                                              Upload PDF<input type="file" id="update_pdf" name="pdf" class="uploadFile img" value="Upload File" style="width: 0px;height: 0px;overflow: hidden;">
                                          </label>
                                        </div>
                                    </div>
