...
<h3>Our Partner Company Page</h3>
@endsection
@section('content')
    <div class="content">
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Create New Partnar Company</h4>
                        <button data-dismiss="modal" class="close">&times;</button>
                    </div>
                    <div class="modal-body">
                      <form id="insert_ourpartner" enctype="multipart/form-data" class="md-form">
                              {{csrf_field()}}
        ...
        <!-- edit modal -->
                <div class="modal fade" id="edit_modalBox">
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Edit Ourpartner</h4>
                                <button data-dismiss="modal" class="close">&times;</button>
                            </div>
                            <div class="modal-body">
...
@section('js')
    ...
    $.ajaxSetup({
        ...
        $(document).ready( function () {
            ...
            $('#insert_ourpartner').on('submit',function (e)
            {
                e.preventDefault();
            ...
            if(confirm('Are you sure You want to delete!')==true){
                $.ajax({
                        type: "POST",
                        url: "../delete/ourpartner/"+id,

                        cache: false,
                        success: function(data){
                            toastr_success('Delete data successful');
                            load();
                        }
                    });
                }else{
