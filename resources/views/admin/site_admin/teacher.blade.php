                                ...
                                <div class="row">
                                  <div class="col-sm-4 imgUp">
                                      <img src="{{asset('images/default.jpg')}}" id="image" class="imagePreview img-thumbnail">
                                        <label for="upload_photo" class="btn btn-primary upload_btn" id="image_id">Upload</label>
                                        <input type="file" accept="image/png,image/jpeg,image/jpg" name="photo" onchange="displaySelectedPhoto('upload_photo','image')" style="display:none;" id="upload_photo" required>
                                  </div>
                                    <div class="col-sm-8">
                                        <div class="row">
                                        <div class="col-md-12">
                        ...
                        <div class="modal-content">
                            ...
                            <form id="update_data" enctype="multipart/form-data" class="md-form">
                              {{csrf_field()}}
                                ...
                                <div class="row">
                                  <div class="col-sm-4 imgUp">
                                      <img id="image_edit" class="imagePreview img-thumbnail">
                                        <label for="upload_edit_photo" class="btn btn-primary upload_btn" id="image_edit">Upload</label>
                                        <input type="file" accept="image/png,image/jpeg,image/jpg" name="photo" onchange="displaySelectedPhoto('upload_edit_photo','image_edit')" style="display:none;" id="upload_edit_photo">
                                  </div>
                                    <div class="col-sm-8">
                                        <div class="row">
                                        <div class="col-md-12">
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="fb_link">Facebook Link</label>
                                        <input type="text" name="fb_link" class="form-control edit_fb_link">
                                    </div>
                                </div>
                              </div>
                              <div class="row">
            ...
            edit_data=function(id){
                $.ajax({
                  ...
                  success: function(data){
                    ...
                    $('.edit_address').val(department['address']);
                    $('.edit_role').val(department['role']);
                    $('.edit_fb_link').val(department['fb_link']);
