...
@section('page_title','TU Taunggyi | BlogDetail')
@section('content')
...
<div class="col-md-12">
<div class="">
<img src="{{$blog_detail->photo_url}}" class="img-fluid" alt="blog-img" width="100%">
<!-- <div class="blog-date">
...
<span class="text-muted">Date : {{substr($blog_detail->created_at,0,10)}}</span>
